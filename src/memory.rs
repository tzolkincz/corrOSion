...
pub fn init_super_dir_table(pid: u32) -> u64 {
    let mpl4_mask: u64 = 0b00000111; //(level 4 cant be huge), present, CPL3 accessible
    let mpl3_mask: u64 = 0b00000111; //Intel dev manual 3A Table 4-17
    let kernel_mask: u64 = 0b10000011; //huge, present, NOT CPL3 accessible
    let allocated_mask: u64 = 0b10000111; //huge, present, CPL3 accessible
    let not_present_mask: u64 = 0b1000001; //huge, present but NOT CPL3 accessible
